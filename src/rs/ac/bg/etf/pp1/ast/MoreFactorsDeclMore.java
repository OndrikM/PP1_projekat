...
public class MoreFactorsDeclMore extends MoreFactors {

    private MoreFactors MoreFactors;
    private Mulop Mulop;
    private Factor Factor;

    public MoreFactorsDeclMore (MoreFactors MoreFactors, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MoreFactorsDeclMore(\n");
