...
public class OptionAddopDeclMore extends OptionAddop {

    private OptionAddop OptionAddop;
    private Addop Addop;
    private Term Term;

    public OptionAddopDeclMore (OptionAddop OptionAddop, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OptionAddopDeclMore(\n");
