...
public class DesignatorStatementListDeclMore extends DesignatorStatementList {

    private DesignatorStatementList DesignatorStatementList;
    private DesignatorStatement DesignatorStatement;

    public DesignatorStatementListDeclMore (DesignatorStatementList DesignatorStatementList, DesignatorStatement DesignatorStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementListDeclMore(\n");
