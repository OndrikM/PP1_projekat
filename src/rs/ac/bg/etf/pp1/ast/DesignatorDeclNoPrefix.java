...
public class DesignatorDeclNoPrefix extends Designator {

    private String name;
    private IdentExprOptionList IdentExprOptionList;

    public DesignatorDeclNoPrefix (String name, IdentExprOptionList IdentExprOptionList) {
        this.name=name;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorDeclNoPrefix(\n");
